...
import argparse
import os
from rdfsensei.datagen.graph_dataset_generator import GraphDatasetGenerator  # Assuming this is in 'graph_dataset_generator.py'
from riqme.sparql.EndpointRiken import Endpoint as EndpointRiken # Import the Endpoint class
from riqme.sparql.Endpoint import Endpoint  # Import the Endpoint class
...
def main():
    ...
    parser.add_argument('graph_source', type=str, help="The path to the RDF graph file.")
